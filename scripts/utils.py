...
rm_f_str = 'rm -f {0}'
rm_rf_str = 'rm -rf {0}'
scp_str = 'scp -o StrictHostKeyChecking=no {0} {1}@{2}:{3}'
...
label_add_str = 'docker node update --label-add {0} {1}'
application_deploy_str = 'docker stack deploy --compose-file={0} {1}'
ps_grep_str = 'docker ps | grep {0}'
top_str = 'docker top {0}'
perf_str = 'perf record -F 250 -e {0} --call-graph lbr -p {1} sleep 120'
